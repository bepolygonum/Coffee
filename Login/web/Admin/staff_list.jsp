...
<sql:query dataSource="${snapshot}" var="result">
    ...
    <div class="wrap">
        ...
        <div class="operate">
            <form action="/Admin/ServletQueryAdmin?web=staff_list" method="post">
        ...
        <table class="list-style Interlaced">
            ...
            <c:forEach var="row" items="${result.rows}">
                <tr>
                    ...
                    <td class="center">${row.Aemail}</td>
                    <td class="center">${row.Agender}</td>
                    <td class="center">
                        <a href="revise_password.jsp?name=${row.Aname}" class="inline-block" title="Edit">
