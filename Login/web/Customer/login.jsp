...
<head>
    ...
    <title>Login</title>
    <link rel="stylesheet" type="text/css" href="<%=path%>/Customer/css/normalize.css" />
    <link rel="stylesheet" type="text/css" href="<%=path%>/Customer/css/demo.css">
    <link rel="stylesheet" href="<%=path%>/Customer/css/style.css">
    <script>
        function nameIsAvail() {
            var x=document.getElementById("name").value
            if(x==0)
            {
                q=document.getElementById("hidname");
                q.innerHTML="*Please Enter Your Name";
            }
            ...
            {
                q=document.getElementById("hidname");
                q.innerHTML="*Wrong Name Format!";
            }
        }

        function passIsAvail() {
            var x=document.getElementById("password").value
            if(x==0)
            {
                q=document.getElementById("hidpass");
                q.innerHTML="*Please Enter Your Password";
            }
            else if(/^[0-9a-zA-Z-_]{5,}$/.test(x))
            {
                q=document.getElementById("hidpass");
                q.innerHTML="";
            ...
            {
                q=document.getElementById("hidpass");
                q.innerHTML="*Wrong PassWord Format!";
            }
        }
    </script>
</head>
...
<div class="top-buttons-agileinfo">
    ...
    <a href="../Forget_Password/forget.jsp">Forget</a>
</div>
<div class="htmleaf-container">
    ...
    <div id="js-modal-holder" class="modal-holder">
        ...
        <form action="/Customer/ServletLoginCustomer" method="post" id="js-modal" class="modal">
            ...
            <div class="modal__header1">Sign In</div>
            <div class="modal__description1">Enter Your Information To Sign In</div>
            <div class="modal__section">
                <div class="input-with-label">

                    <input id="name" type="text" class="input-with-label__input" name="Cname" onblur="nameIsAvail()"/>
                    <label for="name" class="input-with-label__label">username
                        <div class="input-with-label__label__corner"></div>
                    </label>
                        <p class="hidden" id="hidname"></p>
            ...
            <div class="modal__section">
                <div class="input-with-label">
                    ...
                    <input id="password" type="password" name="Cpassword" class="input-with-label__input" onblur="passIsAvail()"/>
                    <label for="password" class="input-with-label__label">password
                        <div class="input-with-label__label__corner"></div>
                    </label>
                        <p class="hidden" id="hidpass"></p>
...
<script type="text/javascript" src="<%=path%>/Customer/js/jquery-2.1.1.min.js"></script>
<script type="text/javascript" src='<%=path%>/Customer/js/howler.min.js'></script>
<script type="text/javascript" src='<%=path%>/Customer/js/tween.min_1.js'></script>
<script type="text/javascript" src='<%=path%>/Customer/js/html2canvas.js'></script>
