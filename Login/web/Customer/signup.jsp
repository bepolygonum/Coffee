...
<head>
    ...
    <script>
        ...
        function cpassIsAvail() {
            var x=document.getElementById("password1").value
            if(x==0)
            {
                q=document.getElementById("hidcpass");
                q.innerHTML="*Please Enter Your Password";
            }
            else if(/^[0-9a-zA-Z-_]{5,}$/.test(x))
            {
...
<div class="top-buttons-agileinfo">
    <a href="login.jsp">Sign In</a><a href="signup.jsp" class="active">Sign Up</a>
</div>
<div class="htmleaf-container">
    ...
    <div id="js-modal-holder" class="modal-holder">
        ...
        <form action="/Customer/ServletSignupCustomer" method="post" id="js-modal" class="modal">
            ...
            <div class="modal__header">Sign In</div>
            <div class="modal__description">this is a login window, click × to close it</div>
            ...
            <div class="modal__section">
                <div class="input-with-label">
                    <input id="password1" type="password" class="input-with-label__input" onblur="cpassIsAvail()"/>
                    <label for="password" class="input-with-label__label">confirm password
                        <div class="input-with-label__label__corner"></div>
                    </label>
                    <p class="hidden" id="hidcpass"></p>
                </div>
            </div>
