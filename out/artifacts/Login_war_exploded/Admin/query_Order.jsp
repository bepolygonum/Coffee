...
<div class="wrap">
    ...
    <div class="operate">
        <form action="/Admin/ServletQueryOrder?webjsp=query_Order" method="post">
    ...
    <table class="list-style Interlaced">
        ...
        <c:forEach var="row" items="${key_list}">
            <tr>
                ...
                <td class="center">
                    <a href="order_detail.jsp?Oid=${row.Oid}&Cid=${row.Cid}&Mnum=${row.Mnum}" class="inline-block" title="view"><img src="images/icon_view.gif" /></a>
