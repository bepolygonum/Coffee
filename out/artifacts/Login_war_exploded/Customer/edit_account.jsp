    ...
    <div class="container">
        ...
        <div class="about-agileinfo w3layouts">
            <div class="mainpart">
                ...
                <div class="rightpart">
                    <div class="part">
                    <form method="post" action="/Customer/ServletEditAccount" enctype="multipart/form-data">
                                    ...
                                    <ul>
                                        <li class="fl">
                                            <p class="account-head">
                                                <img src="../${row.Cprofile}" width="80px" height="80px"/>
                                                <input type="file" id="suoluetu"  name="uploadFile" />

                                            </p>
                                        </li>
                                        <li> <div> &ensp;</div> <div> &ensp;</div><div> &ensp;</div><div> &ensp;</div></li>
                                        <li><div class="info"><p class="mytext">User Name: </p>
                                            <h2 class="show ">
                                                <label class="show__label show__label--ichiro" >
                                                    <input class="input__label-content input__label-content--ichiro" value="${row.Cname}" name="cname" readonly="true">
                                                </label>
                                            </h2>
                                        </div>
                                        </li>
                                        ...
                                        <li><div class="info"><p class="mytext">Email: </p>
                                            <h2 class="show ">
                                                <label class="show__label show__label--ichiro">
                                                <input class="input__label-content input__label-content--ichiro" name="cemail" value="${row.Cemail}">
                                                </label>
                                            </h2>
                                        </div>
                                        </li>
                                        ...
                                        <li><div class="info"><p class="mytext">Telephone: </p>
                                            <h2 class="show ">
                                                <label class="show__label show__label--ichiro" >
                                                    <input class="input__label-content input__label-content--ichiro" name="ctel" value="${row.Ctel}">
                                                </label>
                                            </h2>
                                        </div>
                                        </li>
                                        ...
                                        <li><div class="info"><p class="mytext">Gender: </p>
                                            <h2 class="show ">
                                                <label class="show__label show__label--ichiro" >
                                                    <input class="input__label-content input__label-content--ichiro" name="cgender" value="${row.Cgender}">
                                                </label>
                                            </h2>
                                        </div>
                                        </li>
                                        ...
                                        <li><div class="info"><p class="mytext">Birth: </p>
                                            <h2 class="show ">
                                                <label class="show__label show__label--ichiro" >
                                                    <input id="datepicker" class="input__label-content input__label-content--ichiro"  name="cbirth" value="${row.Cbirth}">
