...
<sql:query dataSource="${snapshot}" var="result">
    SELECT *FROM test.order where Cname = '<%=username%>';
</sql:query>
...
<div class="about">
    <div class="container">
        <h3 class="w3_agile_header">Orders</h3>
                    ...
                    <div class="part">
                        <div class="manage account-manage">
                            <div class="manage-head">
                                <h6 class="layout padding-left manage-head-con">&ensp; Orders</h6>
                            </div>
                            <div class="order-style clearfix">
                                <table class="list-style Interlaced">
                                    ...
                                    <tr>
                                        <td class="center">
                                            ...
                                            <a href="order_detail.jsp?Oid=${row.Oid}">${row.Oid}</a>
                                        </td>
                                        <td class="center">
                                            <span>${row.Mnum}</span>
                                        </td>
                                        ...
                                        <td class="center">
                                            <span>$${row.Odiscount}</span>
                                        </td>
                                        <td class="center">
                                            <span>${row.Ofinish}</span>
                                        </td>
                                    </tr>
                                    </c:forEach>
                                </table>
