...
<div class="about">
    <div class="container">
        <h3 class="w3_agile_header">Details</h3>
                    ...
                    <div class="part">
                        <div class="manage account-manage">
                            <div class="manage-head">
                                <h6 class="layout padding-left manage-head-con">&ensp; Details
                                    <a class="buttonstyle" href="order.jsp">Back</a></h6>
                            </div>
